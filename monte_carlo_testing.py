...
all_bearings = np.load('data/all_bearings.npy')
all_pixel_sizes = np.load('data/all_pixel_sizes.npy')
all_true_distance = np.load('data/all_distances.npy')
all_mav_states = np.load('data/all_mav_states.npy')
all_us = np.load('data/all_us.npy')
...
# TODO continue development on using the simulated data

mu_inverse_distance = np.array([0, 0, all_bearings[0], 1/all_true_distance[0]])
